...
class InscriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inscription" do
    assert_difference('Inscription.count') do
      post inscriptions_url, params: { inscription: { adresse_mail: @inscription.adresse_mail, nom: @inscription.nom, password: @inscription.password, prenom: @inscription.prenom } }
    end
  ...
  test "should update inscription" do
    patch inscription_url(@inscription), params: { inscription: { adresse_mail: @inscription.adresse_mail, nom: @inscription.nom, password: @inscription.password, prenom: @inscription.prenom } }
